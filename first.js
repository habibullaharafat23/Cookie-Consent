...
<div class=consent-banner-wrapper>
  ...
  <div class=consent-action-footer>
    <div class=action-buttons id=consentActionButtons>
      <button action=accept class="action-btn active" id=acceptConsentButton onclick=acceptConsent()>Accept</button>
      <button action=reject class=action-btn id=rejectConsentButton onclick=rejectConsent()>Reject</button>
      <button action=preference class=action-btn id=preferenceConsentButton onclick=preferenceConsent()>Preference</button>
    </div>
  </div>
